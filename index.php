...
<head>
    ...
    <title>BukuTetsuu | Katalog Buku</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-warning">
        <div class="container">
            <a class="navbar-brand" href="#">BukuTetsuu</a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <a href="ubah.php?id=<?= $b['id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="hapus.php?id=<?= $b['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('apakah Anda yakin?')">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
